...
from s3.views import BucketListView, ObjectListView, BucketCreateView, ObjectCreateView, ObjectDeleteView, BucketDeleteView, ObjectUploadView, ObjectDownloadView
