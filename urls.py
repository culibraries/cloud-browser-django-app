...
from s3.views import BucketListView, ObjectListView, BucketCreateView, ObjectCreateView, ObjectDeleteView, BucketDeleteView, ObjectUploadView
...
urlpatterns = [
    ...
    path('object/upload', ObjectUploadView.as_view())
]
